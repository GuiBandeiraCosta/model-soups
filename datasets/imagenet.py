...
from .imagenet_classnames import get_classnames, get_classnames100
...
class ImageNet100:
    def __init__(self,
                 ...
                 batch_size=32,
                 num_workers=32,
                 classnames='imagenet100',
                 distributed=False):
        self.preprocess = preprocess
        self.location = location
        self.batch_size = batch_size
        self.num_workers = num_workers
        self.classnames = get_classnames100(classnames)
        self.distributed = distributed
...
class ImageNet100Train(ImageNet100):

    def get_test_dataset(self):
        pass


class ImageNet98p(ImageNet100):

    def get_train_sampler(self):
        idx_file = 'imagenet100_98_idxs.npy'
...
class ImageNet2pShuffled(ImageNet100):
